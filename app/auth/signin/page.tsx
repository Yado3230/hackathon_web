...
const SignIn: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-50">
      <div className="rounded-sm border border-stroke bg-white py-10 shadow-lg dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2 px-20">
          ...
          <div className="w-full border-stroke dark:border-strokedark px-5 xl:w-1/2 xl:border-l-2">
